...
public class StatisticsPresenterGO {
    ...
    private void loadBestPointsPerSession() {
        ...
        view.getBestScorePerSession().getData().addAll(List.of(view.getSeriesBestScorePlayer(), view.getSeriesBestScoreComputerAI()));
    }
    ...
    private void loadAvgPointsPerSession() {
        ...
        view.getAverageScorePerSession().getData().addAll(List.of(view.getSeriesAverageScorePlayer(), view.getSeriesAverageScoreComputerAI()));
    }
